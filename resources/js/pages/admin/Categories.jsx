        ...
        <div className="space-y-5">
            <div className="flex flex-wrap items-center justify-between gap-3">
                <div>
                    ...
                    <p className="i10-muted text-sm mt-1">Organize as categorias com busca e paginação.</p>
                </div>
                <Link to="/admin/categorias/criar" className="i10-btn-primary px-4 py-2 text-sm">
                    Nova categoria
                </Link>
            </div>
            ...
            <div className="i10-card p-4">
                <div className="flex flex-wrap gap-3 items-center">
                    ...
                    <span className="text-sm i10-muted">
                        {pagination.total || categories.length} registro(s)
                    </span>
                </div>
            </div>
            ...
            {loading ? (
                ...
                <div className="i10-card p-10 text-center i10-muted">Nenhuma categoria cadastrada.</div>
            ) : (
                            ...
                            {categories.map((cat) => (
                                <tr key={cat.id}>
                                    ...
                                    <td className="px-6 py-4 text-right">
                                        ...
                                        <button onClick={() => handleDelete(cat.id)} className="text-(--i10-danger) inline-flex items-center gap-1.5 hover:underline">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-4 w-4">
